  ...
  module Remessa
    module Cnab400
      class Bradesco < Brcobranca::Remessa::Cnab400::Base
        ...
        attr_accessor :habilita_debito_automatico
        ...
        def monta_detalhe(pagamento, sequencial)
          ...
          detalhe << emite_boleto_para_debito                         # emite boleto para debito                    X[01]       094 a 094
        ...
        def emite_boleto_para_debito
          return 'N' if habilita_debito_automatico.length == 0

          habilita_debito_automatico 
        end
      end
    end
  end
